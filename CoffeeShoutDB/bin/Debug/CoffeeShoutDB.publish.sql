...
GO
PRINT N'Creating [dbo].[CoffeeDate]...';
...
CREATE TABLE [dbo].[CoffeeDate] (
    ...
    [IsPending]     INT           NULL,
    CONSTRAINT [PK_CoffeeDate] PRIMARY KEY CLUSTERED ([CoffeeDateNo] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_CofeeDate_Member]...';


GO
ALTER TABLE [dbo].[CoffeeDate] WITH NOCHECK
    ADD CONSTRAINT [FK_CofeeDate_Member] FOREIGN KEY ([ShoutedBy]) REFERENCES [dbo].[Member] ([ID]);
...
GO
ALTER TABLE [dbo].[CoffeeDate] WITH CHECK CHECK CONSTRAINT [FK_CofeeDate_Member];
